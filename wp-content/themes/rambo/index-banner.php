  ...
  <div class="banner">
    <li>
      ...
      <div class="banner_con">
		...
		<a href="<?php echo $current_options['read_more_button_link']; ?>" <?php if( $current_options['read_more_link_target'] == 1 ) { echo "target='_blank'"; } ?> class="flex_btn button-hide"><?php echo $current_options['read_more_text']; ?></a>
      </div>
    </li>
  </div>
</div>
